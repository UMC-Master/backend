...
export class TipController {
  ...
  private initializeRoutes() {
    ...
    this.router.get(
      '/tips/influencer/sorted',
      authenticateJWT,
      this.getSortedInfluencerTips.bind(this)
    );
  }
  ...
  public async updateTip(
    ...
    try {
      ...
      const updatedTip = await this.tipService.updateTip(
        tipId,
        title,
        content,
        newImages
  ...
  public async getSortedInfluencerTips(
    ...
    try {
      ...
      const tips = await this.tipService.getSortedInfluencerTips(
        page,
        limit,
        sort
      );
